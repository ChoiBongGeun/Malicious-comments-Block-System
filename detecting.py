...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.textBrowser.append("모델을 불러오는중입니다 잠시만 기다려주세요.")

    def retranslateUi(self, Dialog):
        _translate = QtCore.QCoreApplication.translate
        Dialog.setWindowTitle(_translate("Dialog", "댓글분석기"))
...
if __name__ == "__main__":
    ...
    ui.textBrowser.append("덧글을 분석중에 있습니다 잠시만 기다려주세요 ...")
    ...
    ui.textBrowser.append("프로그램이 완료 되었습니다.")    
    app.exec_()
